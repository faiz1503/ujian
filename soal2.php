...
if (empty($_SESSION[username]) AND empty($_SESSION[passuser])){
 ...
 <center>Untuk mengakses soal, Anda harus login <br>";
  echo "<a href=home.php><b>LOGIN</b></a></center>";
}
else{
...
echo "<div style='width:100%; border: 1px solid #EBEBEB; overflow:scroll;height:700px;'>";
 echo '<table width="100%" border="0">';
		...
		while($row =mysql_fetch_array($hasil))
		{
			...
			?>
			<form name="form1" method="post" action="http://localhost/Ujian/index2.php?hal=jawaban2">
