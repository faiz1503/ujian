...
//}
//else{
$login=mysql_query("SELECT * FROM tbl_user WHERE email='$username' AND password='$pass'");
...
if ($ketemu > 0){
 ...
 echo "<script>alert('Login Gagal, username atau password anda salah'); window.location = 'login/login.php'</script>";
}
//}
?>
